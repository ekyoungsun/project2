...
<article id="content">           
    <form name="fmember" class="join">
        ...
        <div class="policy">
            제 1장 총칙<br><br>
            제 1 조 (목적)<br>
            이 이용약관(이하 '약관')은 주식회사 씨이오인터내셔널(이하 회사라 합니다)와 이용 고객(이하 '회원')간에 회사가 제공하는 씨이오인터내셔널 웹사이트 (이하 서비스)의 가입조건 및 이용에 관한 제반 사항과 기타 필요한 사항을 구체적으로 규정함을 목적으로 합니다.<br>
            제 2 조 (이용약관의 효력 및 변경)<br>
            1. 이 약관은 회사 웹사이트에서 온라인으로 공시함으로써 효력을 발생하며, 합리적인 사유가 발생할 경우 관련법령에 위배되지 않는 범위 안에서 개정될 수 있습니다. 개정된 약관은 온라인에서 공지함으로써 효력을 발휘하며, 이용자의 권리 또는 의무 등 중요한 규정의 개정은 사전에 공지합니다.<br>
            ...
            4. 서비스 이용자ID 및 비밀번호의 관리책임은 이용자에게 있습니다. 이를 소홀이 관리하여 발생하는 서비스 이용상의 손해 또는 제3자에 의한 부정이용 등에 대한 책임은 이용자에게 있으며 회사는 그에 대한 책임을 일절 지지 않습니다.<br>
            ...
            (5) 회사로부터 특별한 권리를 부여받지 않고 회사의 클라이언트 프로그램을 변경하거나, 회사의 서버를 해킹하거나, 웹사이트 또는 게시된 정보의 일부분 또는 전체를 임의로 변경하는 행위<br>
            (6) 서비스에 위해를 가하거나 고의로 방해하는 행위<br>
            (7) 본 서비스를 통해 얻은 정보를 회사의 사전 승낙 없이 서비스 이용 외의 목적으로 복제하거나, 이를 출판 및 방송 등에 사용하거나, 제 3자에게 제공하는 행위<br>
            ...
            4 장 서비스의 이용<br><br>
            제 12 조 (서비스 이용 시간)<br>
            1. 서비스 이용은 회사의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간 운영을 원칙으로 합니다. 단, 회사는 시스템 정기점검, 증설 및 교체를 위해 회사가 정한 날이나 시간에 서비스를 일시중단할 수 있으며, 예정되어 있는 작업으로 인한 서비스 일시중단은 웹사이트를 통해 사전에 공지합니다.<br>
            ...
            2. 회사는 서비스상에 게재되어 있거나 본 서비스를 통한 광고주의 판촉활동에 회원이 참여하거나 교신 또는 거래를 함으로써 발생하는 손실과 손해에 대해 책임을 지지 않습니다.<br><br>
            제 5 장 계약 해지 및 이용 제한<br><br>
            제 18 조 (계약 변경 및 해지)<br>
            회원이 이용계약을 해지하고자 하는 때에는 회원 본인이 메디코아 고객센터로 유선연락을 하여야 합니다 (02-2056-2600) <br>
            제 19 조 (서비스 이용제한)<br>
            ...
            2. 상기 이용제한 규정에 따라 서비스를 이용하는 회원에게 서비스 이용에 대하여 별도 공지 없이 서비스 이용의 일시정지, 초기화, 이용계약 해지 등을 불량이용자 처리규정에 따라 취할 수 있습니다.<br><br>
        ...
        <div class="check"><input type="checkbox" id="check02" name="agree">
        ...
        <div class="policy">
            ...
            (1)회사 사이트의 각종서비스를 이용하는데 있어 원활한 서비스 신청 및 회원이 편리하고 유익한 정보를 제공하기 위한 최소한의 정보를 필수 사항으로 수집합니다.<br>
            (2)회사는 신제품 또는 이벤트의 정보안내 서비스와 마케팅활동 및 업무수행을 위한 텔레마케팅 서비스 또는 온라인 마케팅서비스을 위해 개인정보를 수집합니다. <br>
            (3)회사는 이용자의 기본적 인권 침해의 우려가 있는 민감한 개인정보(인종 및 민족, 사상 및 신조, 출신지 및 본적지, 정치적 성향 및 범죄기록, 건강상태 및 성생활 등)는 수집하지 않습니다.<br>
            (4)회원이 제공하신 모든 정보는 상기 목적에 필요한 용도 이외로는 사용되지 않으며 수집 정보의 범위나 사용 목적, 용도가 변경될 시에는 반드시 회원께 사전 동의를 구할 것입니다.
        </div>
        <div class="check">
        ...
        <div class="policy">
            ...
            (1)회사 사이트의 서비스 제공을 위해 제공받는 회원 정보는 성명, 주소, 전화번호, 휴대전화번호, 희망 ID, 비밀번호, e-mail 주소, 기타 회사가 필요하다고 인정하는 사항 입니다. 회원이 회사 사이트의 회원으로서 회사에서 제공하는 서비스를 이용하는 동안 회사는 회원의 개인정보를 계속적으로 보유하며 서비스 제공 등을 위해 이용합니다. 회원의 개인정보는 회원가입을 탈퇴하거나, 회원에서 제명된 때, 개인정보의 수집목적 또는 제공받은 목적이 달성되면 파기됩니다. <br>
            (2)상기 조항에도 불구하고 완료되지 않은 업무수행을 위해서나, 관계 법령의 규정에 따라 보존할 필요성이 있을 경우에는 회원의 개인정보를 계속 관리할 수 있습니다.<br>
        ...
        <div class="policy">
            개인정보의 취급 위탁<br><br>
            회사는 서비스 향상을 위해서 이용자들의 개인정보를 외부전문업체에 위탁하여 처리할 수 있습니다. 개인정보의 처리를 위탁하는 경우에는 미리 그 사실을 이용자들에게 공지할 것입니다. 또한 위탁계약 등을 통하여 서비스제공자의 개인정보보호 관련 지시엄수, 개인정보에 관한 비밀유지, 제3자 제공의 금지 및 사고시의 책임부담 등을 명확히 규정하고 당해 계약내용을 서면 또는 전자적으로 보관하여 이용자의 권익을 보호하고 있습니다.
        </div>
        <div class="check">
        ...
        <!-- // 개인정보의 취급 위탁 -->
        <div class="button">
            <a href="javascript:;" class="check_agree ok">동의</a>
            <button onclick="join_cancel()" class="cancel">취소</button>
        </div>
    </form>
</article>